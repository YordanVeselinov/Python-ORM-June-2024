...
from main_app.choices import MealTypeChoices, DifficultyTypeChoices, WorkoutTypeChoices, LaptopTypeChoices, \
    OperationSystemTypeChoices
...
class Dungeon(models.Model):
    ...
    difficulty = models.CharField(
        max_length=10,
        choices=DifficultyTypeChoices.choices,
    )
...
class Laptop(models.Model):
    brand = models.CharField(
        max_length=20,
        choices=LaptopTypeChoices.choices
    )
    ...
    operation_system = models.CharField(
        max_length=20,
        choices=OperationSystemTypeChoices.choices,
    )
