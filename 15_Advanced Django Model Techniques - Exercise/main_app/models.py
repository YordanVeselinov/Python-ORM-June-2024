...
from main_app.validators import NameContainsOnlyLettersAndSpaces
...
class Customer(models.Model):
    name = models.CharField(
        max_length=100,
        validators=[
            NameContainsOnlyLettersAndSpaces(
    ...
    phone_number = models.CharField(
        max_length=13,
        validators=[
            RegexValidator(r'^\+359[1-9]{9}$', message="Phone number must start with '+359' followed by 9 digits"),
        ]
    )
